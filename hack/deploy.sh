...
SCHEDULER_VERSION="${SCHEDULER_VERSION:-v1.35.5-accelerator.0.10.0}"
...
kubectl -n accelerator-system rollout restart daemonset/accelerator-topology-discovery
kubectl -n accelerator-system rollout status daemonset/accelerator-topology-discovery --timeout=180s
