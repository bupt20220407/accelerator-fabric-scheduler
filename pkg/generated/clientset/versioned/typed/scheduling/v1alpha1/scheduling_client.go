...
type SchedulingV1alpha1Interface interface {
	...
	AcceleratorPlacementPoliciesGetter
	AcceleratorTopologiesGetter
}

// SchedulingV1alpha1Client is used to interact with features provided by the scheduling.bupt.dev group.
type SchedulingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SchedulingV1alpha1Client) AcceleratorPlacementPolicies(namespace string) AcceleratorPlacementPolicyInterface {
	return newAcceleratorPlacementPolicies(c, namespace)
}

func (c *SchedulingV1alpha1Client) AcceleratorTopologies() AcceleratorTopologyInterface {
	return newAcceleratorTopologies(c)
}
